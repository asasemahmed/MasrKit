...
```text
Use MasrKit's egyptian-session-report skill.
...
- Keep file names, commands, and identifiers in English with direction isolation
- RTL page, Cairo font from Google Fonts, light and dark themes with a persistent toggle
- Simple, readable layout that works on mobile
```
