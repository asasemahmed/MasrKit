...
| Estimated delivery | موعد التوصيل المتوقع | هيوصلك يوم / التوصيل المتوقع | Give a realistic window (e.g. `هيوصلك خلال يومين إلى ٣ أيام عمل`) |
...
| Electronic Wallet | محفظة إلكترونية | محفظة كاش (فودافون كاش ومحافظ أخرى) | Egyptian users associate `محفظة` with mobile wallets (Vodafone Cash, Orange Cash, etc.) |
...
| Installments / BNPL | تقسيط / الدفع بالتقسيط | قسّط طلبك (مع ڤاليو أو سهولة) | State monthly payment clearly (e.g. `قسّط على ٦ شهور بمبلغ ... ج.م/شهرياً`) |
