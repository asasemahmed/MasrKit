...
description: Design secure internationalization-aware backends for Egyptian products, including local data, money, time, messaging, OTP, uploads, and provider adapters.
metadata:
  version: 1.0.0
